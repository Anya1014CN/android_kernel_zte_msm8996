...
/* Preserve the panel-native hue ABI used by the device LiveDisplay HAL.
 * Values use the OEM 0..512 scale and are restored after panel power-on. */
...
static const struct file_operations fujisan_hue_fops = {
    .owner = THIS_MODULE,
    .read = fujisan_hue_read,
    .write = fujisan_hue_write,
